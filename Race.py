...
# Read the Excel file and drop rows where Country is South Afric
df = pd.read_csv('https://raw.githubusercontent.com/lottiealice18/Todays-Race-Card/main/Todays_Card_20230710.csv')
...
def horse_search():
    ...
    current_day_csv_url = 'https://drive.google.com/uc?id=1W79DC6em9LffBxNjakRmK7vXuenmAhHu'  # Replace with the actual URL for the current day's CSV file
...
def filter_rank():
    ...
    df_hist = pd.read_csv('https://raw.githubusercontent.com/lottiealice18/Todays-Race-Card/main/Todays_Card_20230710.csv')
