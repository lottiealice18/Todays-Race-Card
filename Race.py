...
df = pd.read_csv('https://raw.githubusercontent.com/lottiealice18/Racing/main/5thJuly.csv')
...
def filter_rank():
    ...
    df_hist = pd.read_csv('https://raw.githubusercontent.com/lottiealice18/Racing/main/5thJuly.csv')
